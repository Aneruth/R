...
# Considering the scheme_management column
# sch_mgt <- function(x){
#   # x$extraction_type <- ifelse(x$extraction_type == 'gravity','gravity',x$extraction_type)
#   # x$extraction_type <- ifelse(x$extraction_type == 'WUG','wug',x$extraction_type)
#   # x$extraction_type <- ifelse(x$extraction_type == 'Water authority','water_auth',x$extraction_type)
#   # x$extraction_type <- ifelse(x$extraction_type == 'Water Board','water_board',x$extraction_type)
#   x$waterpoint_type <- ifelse(x$waterpoint_type != 'communal standpipe' & x$waterpoint_type != 'hand pump','other_watertype',x$waterpoint_type)
#   return(x) # Returns the dataset
# }
# 
